...
namespace DietAppTests.Model
{
    ...
    public class FoodEntryTests
    {
        ...
        {
            FoodEntry entry = new FoodEntry("apple", 100, 1, 3, 11);
        ...
        {
            FoodEntry entry = new FoodEntry("apple", null, 1, 3, 11);
        ...
        {
            FoodEntry entry = new FoodEntry("apple", 100, null, 3, 11);
        ...
        {
            FoodEntry entry = new FoodEntry("apple", 100, 1, null, 11);
        ...
        {
            FoodEntry entry = new FoodEntry("apple", 100, 1, 3, null);
        ...
        public void TestWhenConsumedAtCanBeSpecified()
        {
            ...
            FoodEntry entry = new FoodEntry("apple", 100, 1, 3, 11, specifiedDateTime);
